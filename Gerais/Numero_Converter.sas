...
proc sql;
	...
	input('1234,56'),10.2) as Valor_Euro2 format=euro10.2,
	input(compress('1,234.56',"1234567890-.","k"),10.2) as Valor_Euro3 format=euro10.2, /*Converte para número e usa o compress para limpar o conteúdo */
